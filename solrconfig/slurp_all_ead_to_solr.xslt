...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="foxml:datastream[@ID='EAD']/foxml:datastreamVersion[last()]" name="index_EAD">
    ...
    <!--
      ...
      "ead" element.
    -->
<!-- MD - limit to descriptive fields -->
    <xsl:apply-templates mode="slurping_EAD" select="$content//*[local-name() = 'unittitle']|$content//*[local-name() = 'origination']|$content//*[local-name() = 'bioghist']|$content//*[local-name() = 'abstract']|$content//*[local-name() = 'scopecontent']|$content//*[local-name() = 'controlaccess']">
